...
Dit project bevat een **rule-based agent** voor **Connect Four**, geïmplementeerd met de **PettingZoo**-bibliotheek. De agent volgt **8 strategische regels** en speelt tegen een menselijke speler.
